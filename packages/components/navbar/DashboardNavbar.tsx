			...
			<div className="flex justify-between w-full container">
				...
				<Sheet>
					...
					<SheetContent side="left">
						...
						<div className="flex flex-col space-y-3 ml-8">
							<SheetClose asChild>
								<Link className="text-5 font-normal" href="/dashboard">
									Home
								</Link>
							</SheetClose>
							<SheetClose asChild>
								<Link className="text-5 font-normal" href="/dashboard/files">
									Files
								</Link>
							</SheetClose>
							<SheetClose asChild>
								<Link className="text-5 font-normal" href="/dashboard/shorturls">
									Shorturls
								</Link>
							</SheetClose>
							<SheetClose asChild>
								<Link className="text-5 font-normal" href="/dashboard/pastebin">
									Pastebin
								</Link>
							</SheetClose>
						</div>
				...
				<div className="flex items-center gap-4">
					<div className="flex items-center gap-2 max-sm:hidden">
						...
						<Button asChild variant="link">
							<Link href="/dashboard/shorturls">Shorturls</Link>
						</Button>
						<Button asChild variant="link">
							<Link href="/dashboard/pastebin">Pastebin</Link>
						</Button>
					</div>
