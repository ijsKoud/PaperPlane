...
CREATE TABLE "new_Domain" (
    ...
    "embedColor" TEXT NOT NULL DEFAULT '#000'
);
INSERT INTO "new_Domain" ("audit_log_duration", "backup_codes", "date", "disabled", "domain", "extensions_list", "extensions_mode", "max_storage", "max_upload_size", "name_length", "name_strategy", "password", "pathId", "two_factor_secret") SELECT "audit_log_duration", "backup_codes", "date", "disabled", "domain", "extensions_list", "extensions_mode", "max_storage", "max_upload_size", "name_length", "name_strategy", "password", "pathId", "two_factor_secret" FROM "Domain";
DROP TABLE "Domain";
